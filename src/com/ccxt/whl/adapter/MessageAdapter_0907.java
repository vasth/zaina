...
public class MessageAdapter_0907 extends BaseAdapter {
	...
	public MessageAdapter_0907(Context context, String username, int chatType) {
				...
				public void onClick(View arg0) {
			        ...
			        builder.setItems(strarr, new DialogInterface.OnClickListener()
			        {
			            public void onClick(DialogInterface arg0, int arg1)
			            {
			                ...
			                if (arg1 == 0) {//加好友
			                	Intent intent = new Intent(activity, AlertDialog.class);
								intent.putExtra("msg", "添加好友");
								intent.putExtra("editTextShow", true);
								intent.putExtra("cancel", true);
								intent.putExtra("position", position);
								activity.startActivityForResult(intent,ChatActivity.REQUEST_CODE_ADD_TO_CONTACT);
								return ;
			                }else {//加入黑名单
			                	Intent intent = new Intent(activity, AlertDialog.class);
								intent.putExtra("msg", "移入到黑名单？");
